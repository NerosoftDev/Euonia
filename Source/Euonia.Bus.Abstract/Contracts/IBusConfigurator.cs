...
public interface IBusConfigurator
{
    ...
    /// <summary>
    /// Configures a transport strategy for the specified transport type.
    /// </summary>
    /// <param name="transport">Transport type to configure (e.g. a transport implementation type or identifier).</param>
    /// <param name="configure">Action that configures the <see cref="TransportStrategyBuilder"/> for the transport.</param>
    /// <returns>The current <see cref="IBusConfigurator"/> for fluent configuration.</returns>
    IBusConfigurator SetStrategy(Type transport, Action<TransportStrategyBuilder> configure);
}