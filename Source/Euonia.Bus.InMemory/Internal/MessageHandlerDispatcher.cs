...
internal abstract class MessageHandlerDispatcher
{
		...
		where TMessage : class
	{
		...
		/// </summary>
		private readonly MessageHandler<TRecipient, TMessage> _handler;

		/// <summary>
		/// Initializes a new instance of the <see cref="MessageHandlerDispatcher.For{TRecipient,TMessage}"/> class.
		/// </summary>
