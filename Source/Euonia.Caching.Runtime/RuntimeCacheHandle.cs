...
public class RuntimeCacheHandle<TValue> : BaseCacheHandle<TValue>
{
    ...
    /// 
    public RuntimeCacheHandle(CacheManagerConfiguration managerConfiguration, CacheHandleConfiguration configuration)
    ...
    /// 
    public RuntimeCacheHandle(CacheManagerConfiguration managerConfiguration, CacheHandleConfiguration configuration, RuntimeCacheOptions options)
        : base(managerConfiguration, configuration)
    {
        ...
        {
            _cache = new MemoryCache(_cacheName, options?.AsNameValueCollection());
        }
